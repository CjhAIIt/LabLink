<template>
  <div class="lab-info-index-page">
    <div class="bg-grid"></div>
    <div class="ambient-glow"></div>

    <header class="hero play-anim">
      <div class="hero-content">
        <span class="hero-tag anim-title">实验室信息</span>
        <h1 class="anim-middle">探索我们的实验室</h1>
        <p class="anim-bottom">深入了解每个实验室的历史、成就和团队。</p>
...
.card-icon {
  ...
  background: rgba(14, 165, 233, 0.1); color: var(--brand);
}
